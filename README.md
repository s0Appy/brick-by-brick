...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/s0appy/brick-by-brick:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/s0appy/brick-by-brick:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/s0appy/brick-by-brick
```
